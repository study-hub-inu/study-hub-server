...
public class UpdatePostRequest {
    ...
    @Builder
    public UpdatePostRequest(Long postId, String title, String content, String chatUrl, MajorType major, Integer studyPerson, Integer penalty, String penaltyWay, boolean close, GenderType gender, StudyWayType studyWay, LocalDate studyStartDate, LocalDate studyEndDate) {
        this.postId = postId;
        this.title = title;
